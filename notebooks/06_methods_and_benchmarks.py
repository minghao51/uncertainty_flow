...
@app.cell
def _(mo):
    mo.md(r"""# Methods & Benchmarks Overview
...
@app.cell
def _(mo):
    mo.md(r"""## Model Methodology Reference
...
@app.cell
def _(mo):
    mo.md(r"""### QuantileForestForecaster
...
@app.cell
def _(mo):
    mo.md(r"""### DeepQuantileNet / DeepQuantileNetTorch
...
@app.cell
def _(mo):
    mo.md(r"""### BayesianQuantileRegressor
...
@app.cell
def _(mo):
    mo.md(r"""## Interactive Comparison
...
@app.cell
def _(np, pl, raw, scatter_ds, x_metric, y_metric):
